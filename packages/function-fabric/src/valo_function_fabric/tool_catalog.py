...
class ToolDescriptor(BaseModel):
    ...
    binding_contract: str = RACS_BINDING_CONTRACT
    ...
    def enforce_governance_boundary(self) -> ToolDescriptor:
        ...
        if self.binding_contract != RACS_BINDING_CONTRACT:
            raise ValueError("RACS must remain the binding execution contract")
...
class ToolCatalog:
    ...
    def project(self, tool_id: str, surface: str) -> dict[str, object]:
        ...
        projection: dict[str, object] = {
            ...
            "binding_contract": RACS_BINDING_CONTRACT,
        }
